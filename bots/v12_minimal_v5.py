"""Kaggriculture v12 MINIMAL v5: 1 goose + wheat FEED + melon (fixed placement + daily cycle)."""
...
def agent(obs):
    try:
        ...
        # ===== ФАЗА 1: PLACEMENT (дни 0-3) =====
        if goose_pos is None and day < 4:
        ...
        # Если гусь ещё не размещён и день >= 4 (placement failed)
        else:
            actions_f = ["PASS"]
        
        # Батраки: только melon логистика
        hands_actions = []
