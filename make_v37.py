"""Create v37: zones + straw target 26 + herd 12.

v36 (24 straw) was stable but lost on income. v37 increases target to 26
for more peak income while zones keep the endgame stable.
"""
import re
...
src = src.replace(
    ...
    '''            # ITER37 P2: zone assignment for crop hands
            if i > n_anim_hands:
                half = len(tiles) // 2
...
src = src.replace(
    ...
    '''            # ITER37: straw target 26 tiles (zones make it sustainable).
...
src = src.replace(
    ...
    '"""Kaggriculture v37: zones + straw target 26 + herd 12.'
)

open("bots/v37.py", "w", encoding="utf-8").write(src)
print("v37.py created")
